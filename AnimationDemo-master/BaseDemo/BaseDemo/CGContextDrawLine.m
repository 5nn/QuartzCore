...
@implementation CGContextDrawLine
...
- (void)drawLine{
    ...
    CGContextMoveToPoint(currentContext, 20, 100);
    CGContextAddLineToPoint(currentContext,80, 120);
    CGContextAddLineToPoint(currentContext,50,180);
    CGContextClosePath(currentContext);//闭合path
    CGContextStrokePath(currentContext);//将以上的path绘制出来
}
